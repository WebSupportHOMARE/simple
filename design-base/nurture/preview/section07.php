    ...
    ?>
      <ul class="section07__wrap__list flex">
        ...
        ?>
          <li class="section07__wrap__list__item aLink">
            <div
              class="section07__wrap__list__item__link comModal__link section07__wrap__list__item__link--<?php the_ID(); ?>">
      ...
      <ul class="section07__wrap__modalList">
        ...
        while ($the_query->have_posts()) :
          ...
          $template_name = get_field('designBaseName', $current_page_id);
        ?>
          <li class="section07__wrap__modalList__item">
            <div
              class="section07__wrap__list__item__detail comModal__link__detail section07__wrap__list__item__detail--<?php the_ID(); ?> comSec none">
              <div class="section07__wrap__list__item__detail__imgBox">
                <?php if (has_post_thumbnail()) : ?>
                  <img class="section07__wrap__list__item__detail__imgBox__img"
                    src="<?php echo get_template_directory_uri(); ?>/preview/<?php echo $template_name; ?>/img/postTestImgⅰ.png"
                    alt="<?php the_title(); ?>">
                <?php else : ?>
                  <img class="section07__wrap__list__item__detail__imgBox__img"
              ...
              <div class="section07__wrap__list__item__detail__more">
                <div
                  class="section07__wrap__list__item__detail__more__link comMore__link flex comMore__link--adjust subColor2">
                  <span
                    class="section07__wrap__list__item__detail__more__link__arrow comButton__arrow comButton__arrow__back flex"></span>
                  一覧へ戻る
                </div>
              </div>
            </div>
      ...
      <?php if ($the_query->found_posts > 3) : ?>
        <div class="section07__wrap__more section07__wrap__more--modal">
          <div class="section07__wrap__more__link comMore__link comMore__link--adjust subColor2 flex">セクション07をもっと見る
            <span class="section07__wrap__more__link__arrow comButton__arrow flex"></span>
          </div>
        </div>
      <?php endif; ?>
        ...
        <ul class="section07__wrap__archive__list flex mw">
          ...
          ?>
            <li class="section07__wrap__archive__list__item aLink">
              <div
                class="section07__wrap__archive__list__item__link comModal__link section07__wrap__archive__list__item__link--<?php the_ID(); ?>">
        ...
        <ul class="section07__wrap__archive__modalList">
          ...
          ?>
            <li class="section07__wrap__archive__modalList__item">
              <div
                class="section07__wrap__archive__list__item__detail comModal__link__detail section07__wrap__archive__list__item__detail--<?php the_ID(); ?> comSec none">
                <div class="section07__wrap__archive__list__item__detail__imgBox">
                  <?php if (has_post_thumbnail()) : ?>
                    <img class="section07__wrap__archive__list__item__detail__imgBox__img"
                      src="<?php echo get_template_directory_uri(); ?>/preview/<?php echo $template_name; ?>/img/postTestImgⅰ.png"
                      alt="<?php the_title(); ?>">
                  <?php else : ?>
                    <img class="section07__wrap__archive__list__item__detail__imgBox__img"
                ...
                <div class="section07__wrap__archive__list__item__detail__date"><?php the_time("Y.m.d"); ?>
                </div>
                ...
                <div class="section07__wrap__archive__list__item__detail__more">
                  <div
                    class="section07__wrap__archive__list__item__detail__more__link flex comMore__link comMore__link--adjust subColor2">
                    <span
                      class="section07__wrap__archive__list__item__detail__more__link__arrow comButton__arrow comButton__arrow__back flex"></span>
                    一覧へ戻る
                  </div>
                </div>
              </div>
