  ...
  <div class="section12__wrap mw">
    ...
    ?>
        ...
        ?>
          <li class="section12__wrap__modalList__item">
            <div
              ...
              <div class="section12__wrap__list__item__detail__date"><?php the_time("Y.m.d"); ?></div>
              ...
              <div class="section12__wrap__list__item__detail__more">
                <div
                  class="section12__wrap__list__item__detail__more__link comMore__link comMore__link--adjust flex subColor2">
                  <span
                    class="section12__wrap__list__item__detail__more__link__arrow comButton__arrow comButton__arrow__back flex"></span>
                  一覧へ戻る
                </div>
              </div>
            </div>
      ...
      <?php if ($the_query->found_posts > 12) : ?>
        <div class="section12__wrap__more section12__wrap__more--modal">
          <div class="section12__wrap__more__link comMore__link comMore__link--adjust subColor2 flex">セクション12をもっと見る
            <span class="section12__wrap__more__link__arrow comButton__arrow flex"></span>
          </div>
        </div>
      <?php endif; ?>
    ...
    <div class="section12__wrap__archive none comModal__archive">
      <h2 class="section12__wrap__archive__ttl comSec__ttl subFont01 mw">
        <span class="section12__wrap__archive__ttl__span--top comSec__ttl__span--top">セクション12</span>
        <span class="section12__wrap__archive__ttl__span comSec__ttl__span ">section12</span>
      </h2>
          ...
          ?>
            <li class="section12__wrap__archive__modalList__item">
              <div
                ...
                <div class="section12__wrap__archive__list__item__detail__date"><?php the_time("Y.m.d"); ?></div>

                <h3 class="section12__wrap__archive__list__item__detail__ttl"><?php the_title(); ?></h3>
