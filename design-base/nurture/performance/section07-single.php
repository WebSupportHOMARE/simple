    ...
    <div class="section07__wrap__list__item__detail comSec">
        <div class="section07__wrap__list__item__detail__imgBox">
            <?php if (has_post_thumbnail()) : ?>
                <img class="section07__wrap__list__item__detail__imgBox__img" src="<?php the_post_thumbnail_url(); ?>"
                    alt="<?php the_title(); ?>">
            <?php else : ?>
        ...
        <div class="section07__wrap__list__item__detail__more">
            <a class="section07__wrap__list__item__detail__more__link comMore__link comMore__link--adjust subColor2 flex"
                href="<?php echo home_url('/section07/'); ?>">
                <span
