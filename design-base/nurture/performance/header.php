...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/ fb# prefix属性: http://ogp.me/ns/ prefix属性#">
  ...
  <!-- テストCSS -->
  <!-- <link rel="stylesheet"
        href="<?php echo get_template_directory_uri(); ?>/preview/<?php the_field('designBaseName', 'option'); ?>/css/style<?php the_field('cssVersion', 'option'); ?>.css?<?php echo date('YmdHis'); ?>"> -->
  <!-- カスタムCSS -->
  <link rel="stylesheet"
      ...
      <div class="header__top__menu flex pc">
        <ul class="header__top__menu__list flex">
          <li class="header__top__menu__list__item">
            <a class="header__top__menu__list__item__link<?php if (is_post_type_archive('#') || is_singular("#") || is_page('#')) : ?> active subColor2<?php endif; ?>"
        ...
        <div class="header__top__menu__list__btn">
          <a class="header__top__menu__list__btn__link comMore__link subColor2<?php if (is_post_type_archive('#') || is_singular("#") || is_page('#')) : ?> active<?php endif; ?>"
