                        ...
                        <div
                            ...
                            <div class="section12__wrap__list__item__detail__more">
                                <div
                                    ...
                                    <span
                                        class="section12__wrap__list__item__detail__more__link__arrow comButton__arrow comButton__arrow__back flex">▶︎</span>
                                    一覧へ戻る
                                </div>
                            </div>
                        </div>
            ...
            <?php if ($the_query->found_posts > 12) : ?>
                <div class="section12__wrap__more">
                    <a href="<?php echo home_url('/section12/'); ?>"
                        class="section12__wrap__more__link comMore__link comMore__link--adjust subColor2 flex">セクション12をもっと見る
                        <span class="section12__wrap__more__link__arrow comButton__arrow flex">▶︎</span>
                    </a>
                </div>
            <?php endif; ?>
