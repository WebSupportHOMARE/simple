...
<section id="section12_01" class="section12 comSec">
  <div class="section12__wrap mw">
    ...
    ?>
      ...
      <?php if ($the_query->found_posts > 12) : ?>
        <div class="section12__wrap__more section12__wrap__more--modal">
          <div class="section12__wrap__more__link comMore__link mainColor">セクション12をもっと見る</div>
        </div>
      <?php endif; ?>
    ...
    <div class="section12__wrap__archive none comModal__archive">
      <h2 class="section12__wrap__archive__ttl comSec__ttl subFont01 mw">section12<span
          class="section12__wrap__archive__ttl__span comSec__ttl__span subFont02">セクション12</span></h2>
            ...
            <li class="section12__wrap__archive__modalList__item">
              <div
                ...
                <div class="section12__wrap__archive__list__item__detail__more">
                  <div
                    class="section12__wrap__archive__list__item__detail__more__link comMore__link mainColor">
                    一覧へ戻る</div>
                </div>
              </div>
