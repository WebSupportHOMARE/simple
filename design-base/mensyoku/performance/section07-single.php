...
<section id="section07_01" class="section07__single comSec mainColor">
  <div class="section07__wrap__list__item__detail comSec">
    ...
    <div class="section07__wrap__list__item__detail__more">
      <a class="section07__wrap__list__item__detail__more__link comMore__link subColor" href="<?php echo home_url('/section07/'); ?>">一覧に戻る</a>
    </div>
  </div>
</section>