    ...
    ?>
      ...
      <ul class="section07__wrap__list flex">
        ...
        ?>
          <li class="section07__wrap__list__item aLink">
            <a class="section07__wrap__list__item__link mainColor" href="<?php the_permalink(); ?>">
      ...
      ?>
          <li class="section07__wrap__list__item">
            <div class="section07__wrap__list__item__link comModal__link section07__wrap__list__item__link--<?php the_ID(); ?> mainColor">
              <div class="section07__wrap__list__item__link__imgBox">
                <?php if (has_post_thumbnail()) : ?>
      ...
      ?>
          <li class="section07__wrap__modalList__item">
            <div class="section07__wrap__list__item__detail comModal__link__detail section07__wrap__list__item__detail--<?php the_ID(); ?> comSec mainColor none">
              ...
              <div class="section07__wrap__list__item__detail__date karla"><?php the_time("Y.m.d"); ?></div>
      ...
      <?php if ($the_query->found_posts > 3) : ?>
        <div class="section07__wrap__more">
          <a href="<?php echo home_url('/section07/'); ?>"
            class="section07__wrap__more__link comMore__link mainColor">セクション07をもっと見る</a>
        </div>
      <?php endif; ?>
