  ...
  <section class="footer__wrap flex mw">
    ...
    <ul class="footer__wrap__list flex">
      <li class="footer__wrap__list__item">
        <a href="#" target="_blank" rel="noopener noreferrer">
          <img class="footer__wrap__list__item__img"
            src="https://homare1009xs.xsrv.jp/simple/wp-content/themes/simplecourse/performance/<?php the_field('designBaseName'); ?>/icon/instagram.png"
            alt="Instagram">
        </a>
      </li>
      ...
      <li class="footer__wrap__list__item">
        <a href="#" target="_blank" rel="noopener noreferrer">
          <img class="footer__wrap__list__item__img"
            src="https://homare1009xs.xsrv.jp/simple/wp-content/themes/simplecourse/performance/<?php the_field('designBaseName'); ?>/icon/facebook.png"
            alt="facebook">
        </a>
      </li>
      ...
      <li class="footer__wrap__list__item">
        <a href="#" target="_blank" rel="noopener noreferrer">
          <img class="footer__wrap__list__item__img"
            src="https://homare1009xs.xsrv.jp/simple/wp-content/themes/simplecourse/performance/<?php the_field('designBaseName'); ?>/icon/X.png"
            alt="X">
        </a>
      </li>
      ...
      <li class="footer__wrap__list__item">
        <a href="#" target="_blank" rel="noopener noreferrer">
          <img class="footer__wrap__list__item__img"
            src="https://homare1009xs.xsrv.jp/simple/wp-content/themes/simplecourse/performance/<?php the_field('designBaseName'); ?>/icon/youtube.png"
            alt="youtube">
        </a>
      </li>
      ...
      <li class="footer__wrap__list__item">
        <a href="#" target="_blank" rel="noopener noreferrer">
          <img class="footer__wrap__list__item__img"
            src="https://homare1009xs.xsrv.jp/simple/wp-content/themes/simplecourse/performance/<?php the_field('designBaseName'); ?>/icon/tiktok.png"
            alt="tiktok">
        </a>
      </li>
    </ul>
