...
<section id="section07_01" class="section07 comSec">
  <div class="section07__wrap mw">
    <h2 class="section07__wrap__ttl comSec__ttl">section07<span
        class="section07__wrap__ttl__span comSec__ttl__span">セクション07</span></h2>
    ...
    <ul class="section07__wrap__list flex">
      ...
      <li class="section07__wrap__list__item aLink">
        <div
          class="section07__wrap__list__item__link comModal__link mainColor section07__wrap__list__item__link--<?php the_ID(); ?>">
    ...
    <ul class="section07__wrap__modalList">
      ...
      <li class="section07__wrap__modalList__item">
        <div
          class="section07__wrap__list__item__detail comModal__link__detail section07__wrap__list__item__detail--<?php the_ID(); ?> comSec mainColor none">
          ...
          <div class="section07__wrap__list__item__detail__date">
          ...
          <div class="section07__wrap__list__item__detail__more">
            <div class="section07__wrap__list__item__detail__more__link comMore__link subColor">一覧へ戻る</div>
          </div>
        </div>
    ...
    <div class="section07__wrap__more section07__wrap__more--modal">
      <div class="section07__wrap__more__link comMore__link mainColor">セクション07をもっと見る</div>
    </div>
    <?php endif; ?>
    ...
    <div class="section07__wrap__archive none comModal__archive">
      <h2 class="section07__wrap__archive__ttl comSec__ttl mw">section07<span
          class="section07__wrap__archive__ttl__span comSec__ttl__span">セクション07</span></h2>
      ...
      <ul class="section07__wrap__archive__list flex mw">
        ...
        <li class="section07__wrap__archive__list__item aLink">
          <div
            class="section07__wrap__archive__list__item__link comModal__link mainColor section07__wrap__archive__list__item__link--<?php the_ID(); ?>">
      ...
      <ul class="section07__wrap__archive__modalList">
        ...
        <li class="section07__wrap__archive__modalList__item">
          <div
            class="section07__wrap__archive__list__item__detail comModal__link__detail section07__wrap__archive__list__item__detail--<?php the_ID(); ?> comSec mainColor none">
            ...
            <div class="section07__wrap__archive__list__item__detail__more">
              <div class="section07__wrap__archive__list__item__detail__more__link comMore__link subColor">
                一覧へ戻る</div>
            </div>
          </div>
