...
<section id="section12_01" class="section12 comSec">
  <div class="section12__wrap mw">
    <h2 class="section12__wrap__ttl comSec__ttl">section12<span class="section12__wrap__ttl__span comSec__ttl__span">セクション12</span></h2>
    ...
    ?>
      <ul class="section12__wrap__list flex">
        ...
        ?>
          <li class="section12__wrap__list__item">
            <div class="section12__wrap__list__item__link comModal__link section12__wrap__list__item__link--<?php the_ID(); ?>">
              <div class="section12__wrap__list__item__link__imgBox">
                <?php if (has_post_thumbnail()) : ?>
                  <img class="section12__wrap__list__item__link__imgBox__img img3-2" src="<?php echo get_template_directory_uri(); ?>/preview/<?php echo $template_name; ?>/img/postTestImgⅰ.png" alt="<?php the_title(); ?>">
                <?php else : ?>
      ...
      <ul class="section12__wrap__modalList">
        ...
        ?>
          <li class="section12__wrap__modalList__item">
            <div class="section12__wrap__list__item__detail comModal__link__detail section12__wrap__list__item__detail--<?php the_ID(); ?> comSec none">
              <div class="section12__wrap__list__item__detail__imgBox">
                <?php if (has_post_thumbnail()) : ?>
                  <img class="section12__wrap__list__item__detail__imgBox__img" src="<?php echo get_template_directory_uri(); ?>/preview/<?php echo $template_name; ?>/img/postTestImgⅰ.png" alt="<?php the_title(); ?>">
                <?php else : ?>
                  <img class="section12__wrap__list__item__detail__imgBox__img" src="<?php echo get_template_directory_uri(); ?>/user-img/noimageBeside.png" alt="アイキャッチ画像なし">
                <?php endif; ?>
              </div>
              ...
              <div class="section12__wrap__list__item__detail__more">
                <div class="section12__wrap__list__item__detail__more__link comMore__link mainColor">
                  <span class="section12__wrap__more__link__btn">
                    一覧へ戻る
                  </span>
                </div>
              </div>
      ...
      <?php if ($the_query->found_posts > 12) : ?>
        <div class="section012__wrap__more section12__wrap__more--modal">
          <div class="section12__wrap__more__link comMore__link mainColor">
            <span class="section12__wrap__more__link__btn">
              セクション12をもっと見る
            </span>
          </div>
    ...
    <div class="section12__wrap__archive none comModal__archive">
      <h2 class="section12__wrap__archive__ttl comSec__ttl mw">section12<span class="section12__wrap__archive__ttl__span comSec__ttl__span">セクション12</span></h2>
        ...
        <ul class="section12__wrap__archive__list flex mw">
          ...
          ?>
            <li class="section12__wrap__archive__list__item">
              <div class="section12__wrap__archive__list__item__link comModal__link section12__wrap__archive__list__item__link--<?php the_ID(); ?>">
                <div class="section12__wrap__archive__list__item__link__imgBox">
                  <?php if (has_post_thumbnail()) : ?>
                    <img class="section12__wrap__archive__list__item__link__imgBox__img img3-2" src="<?php echo get_template_directory_uri(); ?>/preview/<?php echo $template_name; ?>/img/postTestImgⅰ.png" alt="<?php the_title(); ?>">
                  <?php else : ?>
        ...
        <ul class="section12__wrap__archive__modalList">
          ...
          ?>
            <li class="section12__wrap__archive__modalList__item">
              <div class="section12__wrap__archive__list__item__detail comModal__link__detail section12__wrap__archive__list__item__detail--<?php the_ID(); ?> comSec none">
                <div class="section12__wrap__archive__list__item__detail__imgBox">
                  <?php if (has_post_thumbnail()) : ?>
                    <img class="section12__wrap__archive__list__item__detail__imgBox__img" src="<?php echo get_template_directory_uri(); ?>/preview/<?php echo $template_name; ?>/img/postTestImgⅰ.png" alt="<?php the_title(); ?>">
                  <?php else : ?>
                    <img class="section12__wrap__archive__list__item__detail__imgBox__img" src="<?php echo get_template_directory_uri(); ?>/user-img/noimageBeside.png" alt="アイキャッチ画像なし">
                  <?php endif; ?>
                </div>
                ...
                <div class="section12__wrap__archive__list__item__detail__more">
                  <div class="section12__wrap__archive__list__item__detail__more__link comMore__link mainColor">
                    <span class="section12__wrap__more__link__btn">一覧へ戻る</span>
                  </div>
                </div>
              </div>
