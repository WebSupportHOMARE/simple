...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/ fb# prefix属性: http://ogp.me/ns/ prefix属性#">
  ...
  <!-- 本番CSS -->
  <link rel="stylesheet" href="https://homare1009xs.xsrv.jp/simple/wp-content/themes/simplecourse/performance/<?php the_field('designBaseName', 'option'); ?>/css/style<?php the_field('cssVersion', 'option'); ?>.css?<?php echo date('YmdHis'); ?>">
  <!-- テストCSS -->
  <!-- <link rel="stylesheet"
