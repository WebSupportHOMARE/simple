...
<section id="section07_01" class="section07__single comSec">
  <div class="section07__wrap__list__item__detail comSec">
    ...
    <div class="section07__wrap__list__item__detail__more">
      <a class="section07__wrap__list__item__detail__more__link comMore__link mainColor" href="<?php echo home_url('/section07/'); ?>"><span class="section07__wrap__more__link__btn">一覧へ戻る</span></a>
    </div>
  </div>
</section>