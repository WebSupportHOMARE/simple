  ...
  <div class="section07__wrap mws">
    ...
    ?>
            ...
            <a class="section07__wrap__list__item__link" href="<?php the_permalink(); ?>">
              <div class="section07__wrap__list__item__link__imgBox">
                <?php if (has_post_thumbnail()) : ?>
                  <img class="section07__wrap__list__item__link__imgBox__img img3-2" src="<?php the_post_thumbnail_url(); ?>" alt="<?php the_title(); ?>">
                <?php else : ?>
      ...
      while ($the_query->have_posts()) :
        $the_query->the_post();
      ?>
          <li class="section07__wrap__list__item">
            <div class="section07__wrap__list__item__link comModal__link section07__wrap__list__item__link--<?php the_ID(); ?>">
              <div class="section07__wrap__list__item__link__imgBox">
                <?php if (has_post_thumbnail()) : ?>
                  <img class="section07__wrap__list__item__link__imgBox__img" src="<?php the_post_thumbnail_url(); ?>" alt="<?php the_title(); ?>">
                <?php else : ?>
                  <img class="section07__wrap__list__item__link__imgBox__img" src="<?php echo get_template_directory_uri(); ?>/user-img/noimageBeside.png" alt="アイキャッチ画像なし">
                <?php endif; ?>
              </div>
          ...
          <li class="section07__wrap__modalList__item">
            <div class="section07__wrap__list__item__detail comModal__link__detail section07__wrap__list__item__detail--<?php the_ID(); ?> comSec none">
              <div class="section07__wrap__list__item__detail__imgBox">
                <?php if (has_post_thumbnail()) : ?>
                  <img class="section07__wrap__list__item__detail__imgBox__img img3-2" src="<?php the_post_thumbnail_url(); ?>" alt="<?php the_title(); ?>">
                <?php else : ?>
                  <img class="section07__wrap__list__item__detail__imgBox__img img3-2" src="<?php echo get_template_directory_uri(); ?>/user-img/noimageBeside.png" alt="アイキャッチ画像なし">
                <?php endif; ?>
              </div>
              ...
              <div class="section07__wrap__list__item__detail__more">
                <div class="section07__wrap__list__item__detail__more__link comMore__link mainColor"><span class="section07__wrap__more__link__btn">一覧へ戻る</span></div>
              </div>
            </div>
      ...
      <?php if ($the_query->found_posts > 3) : ?>
        <div class="section07__wrap__more">
          <a href="<?php echo home_url('/section07/'); ?>" class="section07__wrap__more__link comMore__link mainColor">
