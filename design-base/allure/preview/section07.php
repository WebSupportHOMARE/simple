...
<section id="section07_01" class="section07 comSec">
  <div class="section07__wrap mw">
    <h2 class="section07__inner__wrap__ttl comSec__ttl">
      <span class="section07__inner__wrap__ttl__span comSec__ttl__span">
        section07
      </span>
    ...
    ?>
          ...
          <li class="section07__wrap__modalList__item">
            <div
              ...
              <div class="section07__wrap__list__item__detail__more">
                <div class="section07__wrap__list__item__detail__more__link comMore__link">一覧へ戻る</div>
              </div>
            </div>
      ...
      <?php if ($the_query->found_posts > 3) : ?>
        <div class="section07__wrap__more section07__wrap__more--modal">
          <div class="section07__wrap__more__link comMore__link">セクション07をもっと見る</div>
        </div>
      <?php endif; ?>
    ...
    <div class="section07__wrap__archive none comModal__archive">
      <h2 class="section07__wrap__archive__ttl comSec__ttl mw">
        <span class="section07__wrap__archive__ttl__span comSec__ttl__span">
          section07
        </span>
            ...
            <li class="section07__wrap__archive__modalList__item">
              <div
                ...
                <div class="section07__wrap__archive__list__item__detail__more">
                  <div class="section07__wrap__archive__list__item__detail__more__link comMore__link">一覧へ戻る
                  </div>
                </div>
              </div>
