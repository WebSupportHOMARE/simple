  ...
  <div class="section05__wrap mw">
    ...
    <ul class="section05__wrap__list flex">
      <li class="section05__wrap__list__item">
        <div class="section05__wrap__list__item__imgBox">
          <img class="section05__wrap__list__item__imgBox__img img3-2"
            src="<?php echo get_template_directory_uri(); ?>/user-img/noimageBeside.png" alt="section05_1">
        </div>
      ...
      <li class="section05__wrap__list__item">
        <div class="section05__wrap__list__item__imgBox">
          <img class="section05__wrap__list__item__imgBox__img img3-2"
            src="<?php echo get_template_directory_uri(); ?>/user-img/noimageBeside.png" alt="section05_2">
        </div>
      ...
      <li class="section05__wrap__list__item">
        <div class="section05__wrap__list__item__imgBox">
          <img class="section05__wrap__list__item__imgBox__img img3-2"
            src="<?php echo get_template_directory_uri(); ?>/user-img/noimageBeside.png" alt="section05_3">
        </div>
      ...
      <li class="section05__wrap__list__item">
        <div class="section05__wrap__list__item__imgBox">
          <img class="section05__wrap__list__item__imgBox__img img3-2"
            src="<?php echo get_template_directory_uri(); ?>/user-img/noimageBeside.png" alt="section05_4">
        </div>
