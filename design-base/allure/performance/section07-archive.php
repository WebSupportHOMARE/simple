...
<section id="section07_01" class="section07__archive comSec">
  <div class="section07__wrap__archive section07__wrap__archive--block">
      ...
      <ul class="section07__wrap__archive__list flex mw">
        <?php while (have_posts()) : the_post(); ?>
          <li class="section07__wrap__archive__list__item">
            <a class="section07__wrap__archive__list__item__link aLink" href="<?php the_permalink(); ?>">
            ...
            <li class="section07__wrap__archive__modalList__item">
              <div class="section07__wrap__archive__list__item__detail comModal__link__detail section07__wrap__archive__list__item__detail--<?php the_ID(); ?> comSec none">
                ...
                <div class="section07__wrap__archive__list__item__detail__more">
                  <div class="section07__wrap__archive__list__item__detail__more__link comMore__link mainColor">一覧へ戻る</div>
                </div>
              </div>
